...
public class OutlineUtils {
    ...
    public static void drawOutline(float x, float y, float wdith, float height, float width, float radius, int color) {
        ...
        int i;
        for (i = 0; i <= 90; i += 3)
            GL11.glVertex2d(x + radius + Math.sin(i * MathUtils.PI / 180.0D) * radius * -1.0D, y + radius + Math.cos(i * MathUtils.PI / 180.0D) * radius * -1.0D);

        for (i = 90; i <= 180; i += 3)
            GL11.glVertex2d(x + radius + Math.sin(i * MathUtils.PI / 180.0D) * radius * -1.0D, (y + height) - radius + Math.cos(i * MathUtils.PI / 180.0D) * radius * -1.0D);

        for (i = 0; i <= 90; i += 3)
            GL11.glVertex2d((x + wdith) - radius + Math.sin(i * MathUtils.PI / 180.0D) * radius, (y + height) - radius + Math.cos(i * MathUtils.PI / 180.0D) * radius);

        for (i = 90; i <= 180; i += 3)
            GL11.glVertex2d((x + wdith) - radius + Math.sin(i * MathUtils.PI / 180.0D) * radius, y + radius + Math.cos(i * MathUtils.PI / 180.0D) * radius);
