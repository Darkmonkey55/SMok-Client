...
public class Rat {
    ...
    public static class RatManager {
        ...
        private final ArrayList<Rat> bigRats = new ArrayList<>();
        private int bigRatsCount;
        ...
        public Rat getBigRatByClass(Class<?> rat) {
            return rat != null ? this.bigRats.stream().filter((mod) -> {
    ...
    public static class Var {
        ...
        // Client
        public final static double client_version_client = 1.4;
        ...
        public final static String detector_velocity = "Velocity / BHop " + Var.checks;
