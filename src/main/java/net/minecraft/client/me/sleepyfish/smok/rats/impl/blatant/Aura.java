...
public class Aura extends Rat {
    ...
    public static Notification.Timer renderFakeBlockTimer;
    ...
    public void setup() {
        ...
        renderFakeBlockTimer = new Notification.Timer();
    ...
    private void rotateUrBalls() {
        ...
        if (Math.abs(TargetUtils.getTarget().posX - TargetUtils.getTarget().lastTickPosX) > 0.50 || Math.abs(TargetUtils.getTarget().posZ - TargetUtils.getTarget().lastTickPosZ) > 0.50) {
            ...
            ClientUtils.addDebug("resolved angle: X: " + (int) TargetUtils.getTarget().posX + ", Y: " + (int) TargetUtils.getTarget().posY + ", Z: " + (int) TargetUtils.getTarget().posZ);
        }
    ...
    private Entity getTarget() {
            ...
            do {
                do {
                    do {
                        ...
                        } while (!thruWalls.isToggled() && !mc.thePlayer.canEntityBeSeen(target));
        ...
        } while (fov.isToggled() && !Utils.Combat.isInFov(target, fovRange.getValueToFloat()));
