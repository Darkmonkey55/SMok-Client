...
public class MinecraftFontRenderer extends CFont {
    ...
    CharData[] boldChars = new CharData[256], italicChars = new CharData[256], boldItalicChars = new CharData[256];
    ...
    public void drawStringWithClientColorAndOpacity(String text, double x, double y, int opacity, boolean shadow) {
