package net.minecraft.client.me.sleepyfish.smok.utils.render.shader;
...
public class ShaderUtils {
    ...
    public ShaderUtils(String fragShaderLoc, String shaderLoc) {
        ...
        try {
            int fragmentShaderID = createShader(mc.getResourceManager().getResource(new ResourceLocation(fragShaderLoc)).getInputStream(), GL20.GL_FRAGMENT_SHADER);
            GL20.glAttachShader(program, fragmentShaderID);
            int vertexShaderID = createShader(mc.getResourceManager().getResource(new ResourceLocation(shaderLoc)).getInputStream(), GL20.GL_VERTEX_SHADER);
    ...
    public ShaderUtils(String fragmentShaderLoc) {
        this(fragmentShaderLoc, FileUtils.path + "/shaders/vertex.vsh");
    }
