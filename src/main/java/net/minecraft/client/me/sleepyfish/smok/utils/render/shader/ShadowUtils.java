...
public class ShadowUtils {
    ...
    public static ShaderUtils gaussianBloom = new ShaderUtils(FileUtils.path + "/shaders/shadow.frag");
    ...
    public static void setupUniforms(int radius, int directionX, int directionY, FloatBuffer weights) {
        gaussianBloom.setUniform("inTexture", 0);
        gaussianBloom.setUniform("textureToCheck", 16);
